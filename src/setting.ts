import { emptyOr } from './utils/utils.js';
...
export const setting = {
    ...
    init() {
        this.maxTokens = emptyOr(global.db.get('maxTokens'), parseInt(process.env.DEFAULT_MAX_TOKENS), CONSTANT.DEFAULT_MAX_TOKENS);
        this.maxPrompts = emptyOr(global.db.get('maxPrompts'), parseInt(process.env.DEFAULT_MAX_PROMPTS), CONSTANT.DEFAULT_MAX_PROMPTS);
